...
def main():
    lista_categorias_possiveis = "Eletrônicos Verdes, Moda Sustentável, Produtos de Limpeza Ecológicos Orgânicos, Alimentos Orgânicos, Produtos de Higiene Sustentáveis"
